...
//		g2.setFont(g2.getFont().deriveFont(Font.BOLD, 25F));
	...
	public void drawTitleScreen() {
			...
			//TITLE NAME
			g2.setFont(purisaB.deriveFont(Font.BOLD,60F));             //96F FOR MARUMONICA FONT and 60F FOR PURISA
	...
	public void drawDialougeScreen() {
		...
		if(npc.dialouges[npc.dialogueSet][npc.dialougeIndex] != null) {
//			currentDialouge = npc.dialouges[npc.dialogueSet][npc.dialougeIndex];
			
			char characters[] = npc.dialouges[npc.dialogueSet][npc.dialougeIndex].toCharArray();
	...
	public void drawCharacterScreen() {
		...
		g2.drawString("Coin", textX, textY);textY += lineHeight + 7;
		g2.drawString("Weapon", textX, textY);textY += lineHeight + 2;
		...
		g2.drawImage(gp.player.currentWeapon.down1, tailX - gp.tileSize, textY - 33, null);
		textY += gp.tileSize;
		g2.drawImage(gp.player.currentShield.down1, tailX - gp.tileSize, textY - 39, null);
	...
	public void options_top(int frameX, int frameY) {
		...
		int voulmeWidth = 24 * gp.music.volumeScale;
		g2.fillRect(textX, textY, voulmeWidth, 24);
		
		// SOUND EFFECT(SE) VOLUME
		textY += gp.tileSize;
		g2.drawRect(textX, textY, 120, 24);
	    voulmeWidth = 24 * gp.se.volumeScale;
		g2.fillRect(textX, textY, voulmeWidth, 24);
