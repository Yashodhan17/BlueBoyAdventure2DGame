...
public class Player extends Entity{
	...
	public void setDefaultValues() {
		...
		worldX = gp.tileSize * 23;//25//23
		worldY = gp.tileSize * 21;//28//21
...
//		gp.currentMap = 3;
		...
		dexterity = 4; // THE MORE DEXTERITY HE HAS, THE LESS DAMAGE HE RECIEVES 
		exp = 0;
		nextLevelExp = 5;
		coin = 500;
	...
	public void setDialogue() {
		...
		dialouges[0][0] = "You are level " + level + " now!\n"
				+ "You feel stronger!";
	}
